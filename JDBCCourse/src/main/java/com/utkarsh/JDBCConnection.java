    ...
    @PostConstruct //-> This tells Spring to run the method right after everything is set up and ready, so you can do any final setup work.
        public void connect()
        {
            try{
                ...
                ResultSet rs = st.executeQuery("SELECT * FROM student WHERE sid = 1"); // ResultSet is a table of data representing a database result set, which is usually generated by executing a statement that queries the database.
